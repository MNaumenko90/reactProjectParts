...
// Components
import SectionDevelopersFilterComp from './SectionDevelopersFilter';
import AllDevelopersComp from './AllDevelopers';
import Pagination from '../../../objects/components/Pagination';
//Images
import ListingBg from './assets/images/listingDevBg.png';
...
class ListingAgency extends Component {
    ...
    render() {
        ...
        return (
                <div>
                    <Helmet>
                        <title>{`Застройщики, страница ${activePage? activePage : ''}`}</title>
                        <meta name = "description" content={`Список застройщиков в Беларуси, страница-${activePage? activePage : ''}, с рейтингом, контактами и тд.`} />
                    </Helmet>
                    <main>
                        <SectionDevelopersFilterComp/>
                            ...
                            <Grid container spacing={24} className={classes.root} align={'center'}>
                                <Grid item xs={12} sm={12} md={7}>
                                    <nav className={classes.navigation}>
                                        ...
                                        {/*<NavLink exact activeClassName="active" to='/Developers'>Застройщики</NavLink>*/}
                                    </nav>
                                </Grid>
