...
class SectionAgencyFilterComp extends Component {
    state = {
        valueCity:'0',
    ...
    render() {
        ...
        return (
            <section className={classes.smallFilter} style={{...this.props.style}}>
                <Grid container spacing={16} className={classes.root} align={'center'} justify={'center'}>
...
export default withStyles(styles)(SectionAgencyFilterComp);