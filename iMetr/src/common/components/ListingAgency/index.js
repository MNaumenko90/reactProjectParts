...
// Components
import SectionAgencyFilterComp from './SectionAgencyFilter';
import AllAgencyComp from './AllAgency';
import Pagination from '../../../objects/components/Pagination';
//Images
import ListingBg from './assets/images/listingAg.png';
...
class ListingAgency extends Component {
    ...
    render() {
        ...
        return (
                <div>
                    <Helmet>
                        <title>{`Агентства недвижимости, страница ${activePage? activePage : ''}`}</title>
                        <meta name = "description" content={`Лучшие агентства недвижимости в Беларуси, страница-${activePage? activePage : ''}`} />
                    </Helmet>
                <main>
                    <SectionAgencyFilterComp/>
                    <section className={classes.crumbsBg}>
                        <Grid container spacing={24} className={classes.root}>
                            <Grid item xs={12}>
                                <Typography type="headline" className={classes.subHead}>
                                    Агентства недвижимость
                                </Typography>
                            </Grid>
                            <Grid item xs={12}>
                        ...
                        <Grid container spacing={24} className={classes.root} align={'center'}>
                            <Grid item xs={12} sm={12} md={7}>
                                <nav className={classes.navigation}>
                                    {/*<NavLink exact activeClassName="active" to='/ListingAgency'>Агентства недвижимости</NavLink>*/}
                                    {/*<NavLink activeClassName="active" to='/Rieltors'>Риэлтеры и агенты</NavLink>*/}
