...
import SectionFaqNavigationComp from './SectionFaqNavigation';
//Images
...
class Faq extends Component {
    ...
    render() {
        ...
        return (
                <div>
                    <Helmet>
                        <title>Помощь iMetr.by</title>
                        <meta name='description' content="iMetr.by - интернет-сервис для покупателей и арендаторов жилья. Руководство пользователя iMetr.by" />
                    </Helmet>
                    <main>
