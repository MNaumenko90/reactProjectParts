...
import RieltorItem from './RieltorItem';
import AboutRieltor from './AboutRieltor';
...
import RieltorRate from './RieltorRate';
...
class RieltorsPage extends Component {
    state = {
        value: 0,
        onMapValue: 0,
    };
    ...
    render() {
        ...
        return (
                <div>
                    <Helmet>
                        <title>Роман Мамлин</title>
                        <meta name = "description" content={`Осуществляю все операции с недвижимостью : консультации , оформление документов любой сложности , юридические услуги, приватизация, ипотека, дарение, материнский капитал, жилищный сертификат.`} />
                    </Helmet>
                <main>
                    <BreadCrumbs/>
                    <RieltorItem/>
...
export default withStyles(styles)(RieltorsPage);